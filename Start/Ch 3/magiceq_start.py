...
class Book:
    ...
    # this way we can compare objects by checking their values, if we don't 
    # update this method b1 and b3 would return false, as both objects take different space
    # in the memory, despite having the same values, therefore are different
